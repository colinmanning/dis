...
public class HttpHelper {
   ...
   /**
    * Send a a HTTP Post to a URL and return the response data TODO handle response error codes etc.
    *
    * @param postUrl
    * @param encoding
   ...
   /**
    * Send a HTML Get to URL and return the response data TODO handle response error codes etc.
    *
    * @param getUrl
    * @param encoding
    * @param params
   ...
   /**
    * Sent a HTML Put to URL and return the response data TODO handle response error codes etc.
    *
    * @param putUrl
    * @param encoding
    * @param params
   ...
   /**
    * Sent a HTML Delete to URL and return the response data TODO handle response error codes etc.
    *
    * @param deleteUrl
    * @param encoding
    * @param params
